...
const unsigned int snakeTiles[40] __attribute__((aligned(4))) __attribute__((visibility("hidden")))=
{
...
const unsigned short snakeMap[4] __attribute__((aligned(4))) __attribute__((visibility("hidden")))=
{
