...
const unsigned int snailTiles[40] __attribute__((aligned(4))) __attribute__((visibility("hidden")))=
{
...
const unsigned short snailMap[4] __attribute__((aligned(4))) __attribute__((visibility("hidden")))=
{
